...
Options:
  - [list any design plans you find in .techne/tasks/]
...
1. Implementation plan directory name (`.techne/tasks/YYYY-MM-DD-{slug}/`)
...
**Check if `.techne/implementation-plan-guidance.md` exists:**

Use the Read tool to check if `.techne/implementation-plan-guidance.md` exists in the session's working directory.

**If the file exists:**

1. Use TaskCreate to add: "Read project implementation guidance from [absolute path to .techne/implementation-plan-guidance.md]"
...
- Write implementation plan to `.techne/tasks/`
...
...
✔ #N Finalization: Run morphe:code-reviewer...
...
cat /path/to/plugins/techne/skills/starting-an-implementation-plan/SKILL.md
```
...
ls -d "${WORKING_ROOT}/.techne/tasks/YYYY-MM-DD-feature-name"
```
...
/techne:implement /Users/ed/project/.techne/tasks/2025-01-17-oauth2-feature/
...
The /techne:implement command will implement the plan task-by-task with code review between tasks.
```
...
| Mistake | Fix |
|---------|-----|
| Invoking /techne:implement directly | Provide copy-paste instructions instead |
