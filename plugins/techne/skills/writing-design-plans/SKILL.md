...
description: Use after brainstorming completes - writes validated designs to .techne/tasks/ with structured format and discrete implementation phases required for creating detailed implementation plans
...
- Good: `.techne/tasks/2025-01-18-user-prof-redesign/spec.md`
- Bad: `.techne/tasks/design/spec.md`
- Bad: `.techne/tasks/new-feature/spec.md`
...
```bash
git add .techne/tasks/YYYY-MM-DD-<topic>/spec.md
...
"Design plan documented in `.techne/tasks/YYYY-MM-DD-<topic>/spec.md` and committed."
