...
For certain patterns, property-based testing provides stronger coverage than example-based tests. See `style:property-based-testing` skill for complete reference.
