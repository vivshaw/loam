...
| Model | Use For | Cost |
|-------|---------|------|
| Opus | Orchestration, complex planning | $15/M output |
| Sonnet | Focused implementation | $15/M output |
| Haiku | Simple tasks (90% of Sonnet capability) | $5/M output |

Haiku makes multi-agent orchestration economically viable.
