...
**REQUIRED SKILL:** You MUST use the `morphe:investigating-a-codebase` skill when executing your prompt.

**REQUIRED SKILL:** You MUST use the `morphe:researching-on-the-internet` skill when executing your prompt.
